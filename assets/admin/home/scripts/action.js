...
const configure = () => {
    ...
    $(document).on("click", "#app-loader-3quilibrium .admin-page .content .menu #user-management", () => {
        location.href = "../user-management/";
    });

    $(document).on("click", "#app-loader-3quilibrium .admin-page .content .menu #setting", () => {
